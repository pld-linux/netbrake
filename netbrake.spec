...
Netbrake is an utility to limit the bandwidth used by a process.
  ...
  so you can use the standard text utils against some URL

%description -l pl

Netbrake jest narzêdziem do ograniczania przepustowosci ³acza u¿ywanego przez proces.
nie wymaga modyfikacji kernela ,dzia³a na zwyk³ym koncie
jest u¿ywany g³ównie wtedy je¿eli chcemy sci±gn±c du¿e pliki np za pomoc± wgeta czy lynxa
